...
exports.UsuariosModule = UsuariosModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([usuario_entity_1.UsuarioEntity, otp_entity_1.OtpEntity]),
            mongoose_1.MongooseModule.forFeature([{ name: session_audit_schema_1.SessionAudit.name, schema: session_audit_schema_1.SessionAuditSchema }]),
